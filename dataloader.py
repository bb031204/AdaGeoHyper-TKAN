...
def load_dataset(dataset_dir, batch_size, position_file, val_batch_size=None, include_context=False, **kwargs):
    ...
    data = {}
    data['train_loader'] = torch.utils.data.DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=0)
    data['val_loader']  = torch.utils.data.DataLoader(validation_set, batch_size=val_batch_size, shuffle=False, num_workers=0)
    data['test_loader'] = torch.utils.data.DataLoader(test_set, batch_size=val_batch_size, shuffle=False, num_workers=0)
    data['scaler'] = scaler
